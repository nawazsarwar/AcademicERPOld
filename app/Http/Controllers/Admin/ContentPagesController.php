...
class ContentPagesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.contentPages.create', compact('approved_bies', 'categories', 'deleted_bies', 'tags', 'users', 'websites'));
    }
    ...
    public function edit(ContentPage $contentPage)
    {
        ...
        return view('admin.contentPages.edit', compact('approved_bies', 'categories', 'contentPage', 'deleted_bies', 'tags', 'users', 'websites'));
    }

...
class ProgrammeDeliveryModeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.programmeDeliveryModes.index', compact('programmeDeliveryModes'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.programmeDeliveryModes.create');
    }
    ...
    public function store(StoreProgrammeDeliveryModeRequest $request)
    {
        ...
        return redirect()->route('admin.programme-delivery-modes.index');
    }
    ...
    public function edit(ProgrammeDeliveryMode $programmeDeliveryMode)
    {
        ...
        return view('admin.programmeDeliveryModes.edit', compact('programmeDeliveryMode'));
    }
    ...
    public function show(ProgrammeDeliveryMode $programmeDeliveryMode)
    {
        ...
        return view('admin.programmeDeliveryModes.show', compact('programmeDeliveryMode'));
    }

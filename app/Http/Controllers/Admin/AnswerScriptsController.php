...
class AnswerScriptsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.answerScripts.index', compact('answerScripts'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.answerScripts.create', compact('papers', 'users'));
    }
    ...
    public function store(StoreAnswerScriptRequest $request)
    {
        ...
        return redirect()->route('admin.answer-scripts.index');
    }
    ...
    public function edit(AnswerScript $answerScript)
    {
        ...
        return view('admin.answerScripts.edit', compact('answerScript', 'papers', 'users'));
    }
    ...
    public function show(AnswerScript $answerScript)
    {
        ...
        return view('admin.answerScripts.show', compact('answerScript'));
    }

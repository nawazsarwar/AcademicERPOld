...
class DesignationTypeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.designationTypes.index', compact('designationTypes'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.designationTypes.create', compact('parents'));
    }
    ...
    public function store(StoreDesignationTypeRequest $request)
    {
        ...
        return redirect()->route('admin.designation-types.index');
    }
    ...
    public function edit(DesignationType $designationType)
    {
        ...
        return view('admin.designationTypes.edit', compact('designationType', 'parents'));
    }
    ...
    public function show(DesignationType $designationType)
    {
        ...
        return view('admin.designationTypes.show', compact('designationType'));
    }

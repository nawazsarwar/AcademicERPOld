...
class ComputerCentreDataController extends Controller
{
    public function index()
    {
        ...
        return view('admin.computerCentreDatas.index', compact('computerCentreDatas'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.computerCentreDatas.create');
    }
    ...
    public function store(StoreComputerCentreDataRequest $request)
    {
        ...
        return redirect()->route('admin.computer-centre-datas.index');
    }
    ...
    public function edit(ComputerCentreData $computerCentreData)
    {
        ...
        return view('admin.computerCentreDatas.edit', compact('computerCentreData'));
    }
    ...
    public function show(ComputerCentreData $computerCentreData)
    {
        ...
        return view('admin.computerCentreDatas.show', compact('computerCentreData'));
    }

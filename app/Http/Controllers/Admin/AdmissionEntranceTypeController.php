...
class AdmissionEntranceTypeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.admissionEntranceTypes.index', compact('admissionEntranceTypes'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.admissionEntranceTypes.create');
    }
    ...
    public function store(StoreAdmissionEntranceTypeRequest $request)
    {
        ...
        return redirect()->route('admin.admission-entrance-types.index');
    }
    ...
    public function edit(AdmissionEntranceType $admissionEntranceType)
    {
        ...
        return view('admin.admissionEntranceTypes.edit', compact('admissionEntranceType'));
    }
    ...
    public function show(AdmissionEntranceType $admissionEntranceType)
    {
        ...
        return view('admin.admissionEntranceTypes.show', compact('admissionEntranceType'));
    }

...
class BiometricsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.biometrics.index', compact('biometrics'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.biometrics.create', compact('users'));
    }
    ...
    public function edit(Biometric $biometric)
    {
        ...
        return view('admin.biometrics.edit', compact('biometric', 'users'));
    }
    ...
    public function show(Biometric $biometric)
    {
        ...
        return view('admin.biometrics.show', compact('biometric'));
    }

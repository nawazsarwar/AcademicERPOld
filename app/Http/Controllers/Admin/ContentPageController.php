...
class ContentPageController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.contentPages.create', compact('categories', 'tags', 'websites'));
    }
    ...
    public function edit(ContentPage $contentPage)
    {
        ...
        return view('admin.contentPages.edit', compact('categories', 'contentPage', 'tags', 'websites'));
    }

...
class ExaminationSchedulesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.examinationSchedules.index', compact('examinationSchedules'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.examinationSchedules.create', compact('academic_sessions', 'papers'));
    }
    ...
    public function store(StoreExaminationScheduleRequest $request)
    {
        ...
        return redirect()->route('admin.examination-schedules.index');
    }
    ...
    public function edit(ExaminationSchedule $examinationSchedule)
    {
        ...
        return view('admin.examinationSchedules.edit', compact('academic_sessions', 'examinationSchedule', 'papers'));
    }
    ...
    public function show(ExaminationSchedule $examinationSchedule)
    {
        ...
        return view('admin.examinationSchedules.show', compact('examinationSchedule'));
    }

...
class ClientsMerchantsController extends Controller
{
    public function index()
    {
        ...
        return view('admin.clientsMerchants.index', compact('clientsMerchants'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.clientsMerchants.create', compact('clients', 'merchants'));
    }
    ...
    public function store(StoreClientsMerchantRequest $request)
    {
        ...
        return redirect()->route('admin.clients-merchants.index');
    }
    ...
    public function edit(ClientsMerchant $clientsMerchant)
    {
        ...
        return view('admin.clientsMerchants.edit', compact('clients', 'clientsMerchant', 'merchants'));
    }
    ...
    public function show(ClientsMerchant $clientsMerchant)
    {
        ...
        return view('admin.clientsMerchants.show', compact('clientsMerchant'));
    }

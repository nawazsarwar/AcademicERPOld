...
class CourseUserController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.courseUsers.index', compact('courseUsers'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.courseUsers.create', compact('admitted_ins', 'courses', 'users', 'verification_statuses', 'verified_bies'));
    }
    ...
    public function store(StoreCourseUserRequest $request)
    {
        ...
        return redirect()->route('frontend.course-users.index');
    }
    ...
    public function edit(CourseUser $courseUser)
    {
        ...
        return view('frontend.courseUsers.edit', compact('admitted_ins', 'courseUser', 'courses', 'users', 'verification_statuses', 'verified_bies'));
    }
    ...
    public function show(CourseUser $courseUser)
    {
        ...
        return view('frontend.courseUsers.show', compact('courseUser'));
    }

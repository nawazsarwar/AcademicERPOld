...
class AdmissionChargesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.admissionCharges.index', compact('admissionCharges'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.admissionCharges.create', compact('courses'));
    }
    ...
    public function store(StoreAdmissionChargeRequest $request)
    {
        ...
        return redirect()->route('frontend.admission-charges.index');
    }
    ...
    public function edit(AdmissionCharge $admissionCharge)
    {
        ...
        return view('frontend.admissionCharges.edit', compact('admissionCharge', 'courses'));
    }
    ...
    public function show(AdmissionCharge $admissionCharge)
    {
        ...
        return view('frontend.admissionCharges.show', compact('admissionCharge'));
    }

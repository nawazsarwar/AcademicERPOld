...
class VerificationStatusesController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.verificationStatuses.index', compact('verificationStatuses'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.verificationStatuses.create');
    }
    ...
    public function store(StoreVerificationStatusRequest $request)
    {
        ...
        return redirect()->route('frontend.verification-statuses.index');
    }
    ...
    public function edit(VerificationStatus $verificationStatus)
    {
        ...
        return view('frontend.verificationStatuses.edit', compact('verificationStatus'));
    }
    ...
    public function show(VerificationStatus $verificationStatus)
    {
        ...
        return view('frontend.verificationStatuses.show', compact('verificationStatus'));
    }

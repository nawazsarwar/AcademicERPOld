...
class EmploymentStatusController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.employmentStatuses.index', compact('employmentStatuses'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.employmentStatuses.create');
    }
    ...
    public function store(StoreEmploymentStatusRequest $request)
    {
        ...
        return redirect()->route('frontend.employment-statuses.index');
    }
    ...
    public function edit(EmploymentStatus $employmentStatus)
    {
        ...
        return view('frontend.employmentStatuses.edit', compact('employmentStatus'));
    }
    ...
    public function show(EmploymentStatus $employmentStatus)
    {
        ...
        return view('frontend.employmentStatuses.show', compact('employmentStatus'));
    }

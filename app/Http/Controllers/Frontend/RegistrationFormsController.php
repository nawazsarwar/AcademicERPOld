...
class RegistrationFormsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.registrationForms.index', compact('registrationForms'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.registrationForms.create', compact('academic_sessions', 'courses', 'programme_duration_types'));
    }
    ...
    public function store(StoreRegistrationFormRequest $request)
    {
        ...
        return redirect()->route('frontend.registration-forms.index');
    }
    ...
    public function edit(RegistrationForm $registrationForm)
    {
        ...
        return view('frontend.registrationForms.edit', compact('academic_sessions', 'courses', 'programme_duration_types', 'registrationForm'));
    }
    ...
    public function show(RegistrationForm $registrationForm)
    {
        ...
        return view('frontend.registrationForms.show', compact('registrationForm'));
    }

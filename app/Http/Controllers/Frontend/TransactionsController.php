...
class TransactionsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.transactions.create', compact('clients', 'merchants', 'orders', 'services'));
    }
    ...
    public function edit(Transaction $transaction)
    {
        ...
        return view('frontend.transactions.edit', compact('clients', 'merchants', 'orders', 'services', 'transaction'));
    }

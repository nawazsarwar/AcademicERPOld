...
class ExaminationMarksController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.examinationMarks.create', compact('academic_sessions', 'students'));
    }
    ...
    public function edit(ExaminationMark $examinationMark)
    {
        ...
        return view('frontend.examinationMarks.edit', compact('academic_sessions', 'examinationMark', 'students'));
    }

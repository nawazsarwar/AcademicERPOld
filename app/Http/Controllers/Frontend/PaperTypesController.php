...
class PaperTypesController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.paperTypes.index', compact('paperTypes'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.paperTypes.create');
    }
    ...
    public function store(StorePaperTypeRequest $request)
    {
        ...
        return redirect()->route('frontend.paper-types.index');
    }
    ...
    public function edit(PaperType $paperType)
    {
        ...
        return view('frontend.paperTypes.edit', compact('paperType'));
    }
    ...
    public function show(PaperType $paperType)
    {
        ...
        return view('frontend.paperTypes.show', compact('paperType'));
    }

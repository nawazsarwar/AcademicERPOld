...
class NotificableController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.notificables.index', compact('notificables'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.notificables.create', compact('notifications'));
    }
    ...
    public function store(StoreNotificableRequest $request)
    {
        ...
        return redirect()->route('frontend.notificables.index');
    }
    ...
    public function edit(Notificable $notificable)
    {
        ...
        return view('frontend.notificables.edit', compact('notificable', 'notifications'));
    }
    ...
    public function show(Notificable $notificable)
    {
        ...
        return view('frontend.notificables.show', compact('notificable'));
    }

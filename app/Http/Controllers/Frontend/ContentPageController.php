...
class ContentPageController extends Controller
{
    ...
    public function index()
    {
        ...
        $contentPages = ContentPage::with(['categories', 'tags', 'website', 'media'])->get();
    ...
    public function create()
    {
        ...
        return view('frontend.contentPages.create', compact('categories', 'tags', 'websites'));
    }
    ...
    public function edit(ContentPage $contentPage)
    {
        ...
        $contentPage->load('categories', 'tags', 'website');

        return view('frontend.contentPages.edit', compact('categories', 'contentPage', 'tags', 'websites'));
    }

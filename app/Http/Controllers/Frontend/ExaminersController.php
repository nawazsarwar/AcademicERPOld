...
class ExaminersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.examiners.index', compact('examiners'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.examiners.create', compact('papers'));
    }
    ...
    public function store(StoreExaminerRequest $request)
    {
        ...
        return redirect()->route('frontend.examiners.index');
    }
    ...
    public function edit(Examiner $examiner)
    {
        ...
        return view('frontend.examiners.edit', compact('examiner', 'papers'));
    }
    ...
    public function show(Examiner $examiner)
    {
        ...
        return view('frontend.examiners.show', compact('examiner'));
    }

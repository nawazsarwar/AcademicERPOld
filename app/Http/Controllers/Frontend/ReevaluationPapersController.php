...
class ReevaluationPapersController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.reevaluationPapers.index', compact('reevaluationPapers'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.reevaluationPapers.create', compact('examination_marks', 'papers', 'reevaluations'));
    }
    ...
    public function store(StoreReevaluationPaperRequest $request)
    {
        ...
        return redirect()->route('frontend.reevaluation-papers.index');
    }
    ...
    public function edit(ReevaluationPaper $reevaluationPaper)
    {
        ...
        return view('frontend.reevaluationPapers.edit', compact('examination_marks', 'papers', 'reevaluationPaper', 'reevaluations'));
    }
    ...
    public function show(ReevaluationPaper $reevaluationPaper)
    {
        ...
        return view('frontend.reevaluationPapers.show', compact('reevaluationPaper'));
    }

...
class CoursePapersController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.coursePapers.index', compact('coursePapers'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.coursePapers.create', compact('academic_sessions', 'courses', 'papers'));
    }
    ...
    public function store(StoreCoursePaperRequest $request)
    {
        ...
        return redirect()->route('frontend.course-papers.index');
    }
    ...
    public function edit(CoursePaper $coursePaper)
    {
        ...
        return view('frontend.coursePapers.edit', compact('academic_sessions', 'coursePaper', 'courses', 'papers'));
    }
    ...
    public function show(CoursePaper $coursePaper)
    {
        ...
        return view('frontend.coursePapers.show', compact('coursePaper'));
    }

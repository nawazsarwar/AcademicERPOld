...
class CourseAcademicSessionsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.courseAcademicSessions.index', compact('courseAcademicSessions'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.courseAcademicSessions.create', compact('academic_sessions', 'courses'));
    }
    ...
    public function store(StoreCourseAcademicSessionRequest $request)
    {
        ...
        return redirect()->route('frontend.course-academic-sessions.index');
    }
    ...
    public function edit(CourseAcademicSession $courseAcademicSession)
    {
        ...
        return view('frontend.courseAcademicSessions.edit', compact('academic_sessions', 'courseAcademicSession', 'courses'));
    }
    ...
    public function show(CourseAcademicSession $courseAcademicSession)
    {
        ...
        return view('frontend.courseAcademicSessions.show', compact('courseAcademicSession'));
    }

...
class WebsitesController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.websites.index', compact('websites'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.websites.create');
    }
    ...
    public function store(StoreWebsiteRequest $request)
    {
        ...
        return redirect()->route('frontend.websites.index');
    }
    ...
    public function edit(Website $website)
    {
        ...
        return view('frontend.websites.edit', compact('website'));
    }
    ...
    public function show(Website $website)
    {
        ...
        return view('frontend.websites.show', compact('website'));
    }

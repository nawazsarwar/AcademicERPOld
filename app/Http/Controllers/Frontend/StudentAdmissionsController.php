...
class StudentAdmissionsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.studentAdmissions.create', compact('courses', 'enrolments', 'sessions'));
    }
    ...
    public function edit(StudentAdmission $studentAdmission)
    {
        ...
        return view('frontend.studentAdmissions.edit', compact('courses', 'enrolments', 'sessions', 'studentAdmission'));
    }

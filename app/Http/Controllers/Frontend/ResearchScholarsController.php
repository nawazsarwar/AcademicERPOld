...
class ResearchScholarsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.researchScholars.index', compact('researchScholars'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.researchScholars.create', compact('registrations', 'supervisors'));
    }
    ...
    public function store(StoreResearchScholarRequest $request)
    {
        ...
        return redirect()->route('frontend.research-scholars.index');
    }
    ...
    public function edit(ResearchScholar $researchScholar)
    {
        ...
        return view('frontend.researchScholars.edit', compact('registrations', 'researchScholar', 'supervisors'));
    }
    ...
    public function show(ResearchScholar $researchScholar)
    {
        ...
        return view('frontend.researchScholars.show', compact('researchScholar'));
    }

...
class AddressesApiController extends Controller
{
    public function index()
    {
        ...
        return new AddressResource(Address::with(['country', 'province', 'postal_code', 'person', 'user'])->get());
    }
    ...
    public function show(Address $address)
    {
        ...
        return new AddressResource($address->load(['country', 'province', 'postal_code', 'person', 'user']));
    }

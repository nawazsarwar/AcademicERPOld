                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.provinces.update", [$province->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="population" id="population" value="{{ old('population', $province->population) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="area" id="area" value="{{ old('area', $province->area) }}" step="1">
                            @if($errors->has('area'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('area') }}
                                </div>

                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.transactions.update", [$transaction->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="currency" id="currency" value="{{ old('currency', $transaction->currency) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="status" id="status" value="{{ old('status', $transaction->status) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="narration" id="narration" value="{{ old('narration', $transaction->narration) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="response" id="response">{{ old('response', $transaction->response) }}</textarea>

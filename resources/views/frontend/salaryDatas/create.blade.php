    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.salary-datas.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ecode" id="ecode" value="{{ old('ecode', '') }}" required>
                            @if($errors->has('ecode'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ecode') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="emp_name" id="emp_name" value="{{ old('emp_name', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="basic" id="basic" value="{{ old('basic', '') }}" step="0.01">
                            @if($errors->has('basic'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('basic') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="desig_name" id="desig_name" value="{{ old('desig_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="emp_status" id="emp_status" value="{{ old('emp_status', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="date_of_join" id="date_of_join" value="{{ old('date_of_join', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sex" id="sex" value="{{ old('sex', '') }}">
                            @if($errors->has('sex'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sex') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="retire_date" id="retire_date" value="{{ old('retire_date', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pf_type" id="pf_type" value="{{ old('pf_type', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="emp_grop" id="emp_grop" value="{{ old('emp_grop', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="leave" id="leave" value="{{ old('leave', '') }}">
                            @if($errors->has('leave'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('leave') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="designation_category" id="designation_category" value="{{ old('designation_category', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="exists_cc" id="exists_cc" value="{{ old('exists_cc', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="import_date" id="import_date" value="{{ old('import_date') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="salary_month" id="salary_month" value="{{ old('salary_month', '') }}">

                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.receivables.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="raised_on" id="raised_on" value="{{ old('raised_on') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="settlement_status" id="settlement_status" value="{{ old('settlement_status', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="settled_on" id="settled_on" value="{{ old('settled_on') }}">

                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.notifications.update", [$notification->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mode" id="mode" value="{{ old('mode', $notification->mode) }}" required>
                            @if($errors->has('mode'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('mode') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="type" id="type" value="{{ old('type', $notification->type) }}" required>
                            @if($errors->has('type'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('type') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="status" id="status" value="{{ old('status', $notification->status) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="json" id="json" required>{{ old('json', $notification->json) }}</textarea>
                            @if($errors->has('json'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('json') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="created_by_id" id="created_by_id" required>
                                @foreach($created_bies as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('created_by_id') ? old('created_by_id') : $notification->created_by->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="try_count" id="try_count" value="{{ old('try_count', $notification->try_count) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="done" id="done" value="{{ old('done', $notification->done) }}" step="1">
                            @if($errors->has('done'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('done') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks">{{ old('remarks', $notification->remarks) }}</textarea>

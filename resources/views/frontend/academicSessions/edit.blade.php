                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.academic-sessions.update", [$academicSession->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sequence" id="sequence" value="{{ old('sequence', $academicSession->sequence) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="status" id="status" value="{{ old('status', $academicSession->status) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks">{{ old('remarks', $academicSession->remarks) }}</textarea>

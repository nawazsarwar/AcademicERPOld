    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.nominees.update", [$nominee->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.nominee.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $nominee->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="address" id="address" value="{{ old('address', $nominee->address) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="relationship" id="relationship" value="{{ old('relationship', $nominee->relationship) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="age" id="age" value="{{ old('age', $nominee->age) }}">
                            @if($errors->has('age'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('age') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="witness_name_1" id="witness_name_1" value="{{ old('witness_name_1', $nominee->witness_name_1) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="designation_witness_1" id="designation_witness_1" value="{{ old('designation_witness_1', $nominee->designation_witness_1) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="department_witness_1" id="department_witness_1" value="{{ old('department_witness_1', $nominee->department_witness_1) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="witness_name_2" id="witness_name_2" value="{{ old('witness_name_2', $nominee->witness_name_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="designation_witness_2" id="designation_witness_2" value="{{ old('designation_witness_2', $nominee->designation_witness_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="department_witness_2" id="department_witness_2" value="{{ old('department_witness_2', $nominee->department_witness_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="status" id="status" value="{{ old('status', $nominee->status) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks">{{ old('remarks', $nominee->remarks) }}</textarea>

        ...
        <div class="col-md-12">
            @can('computer_centre_data_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.computer-centre-datas.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $computerCentreData->id }}">
                                        ...
                                        <td>
                                            @can('computer_centre_data_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.computer-centre-datas.show', $computerCentreData->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('computer_centre_data_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.computer-centre-datas.edit', $computerCentreData->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('computer_centre_data_delete')
                                                <form action="{{ route('frontend.computer-centre-datas.destroy', $computerCentreData->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('computer_centre_data_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.computer-centre-datas.massDestroy') }}",

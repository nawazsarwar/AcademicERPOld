    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.computer-centre-datas.update", [$computerCentreData->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="uri">{{ trans('cruds.computerCentreData.fields.uri') }}</label>
                            <input class="form-control" type="text" name="uri" id="uri" value="{{ old('uri', $computerCentreData->uri) }}" required>
                            @if($errors->has('uri'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="slug" id="slug" value="{{ old('slug', $computerCentreData->slug) }}">
                            @if($errors->has('slug'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('slug') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="type" id="type" value="{{ old('type', $computerCentreData->type) }}">
                            @if($errors->has('type'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('type') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="parser" id="parser" value="{{ old('parser', $computerCentreData->parser) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="data" id="data">{{ old('data', $computerCentreData->data) }}</textarea>
                            @if($errors->has('data'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('data') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="parent" id="parent" value="{{ old('parent', $computerCentreData->parent) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="crawled" id="crawled" value="{{ old('crawled', $computerCentreData->crawled) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="crawled_at" id="crawled_at" value="{{ old('crawled_at', $computerCentreData->crawled_at) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks">{{ old('remarks', $computerCentreData->remarks) }}</textarea>

            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.support-priorities.update", [$supportPriority->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="required" for="color">{{ trans('cruds.supportPriority.fields.color') }}</label>
                            <input class="form-control" type="text" name="color" id="color" value="{{ old('color', $supportPriority->color) }}" required>
                            @if($errors->has('color'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('color') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="status" id="status" value="{{ old('status', $supportPriority->status) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="remarks" id="remarks" value="{{ old('remarks', $supportPriority->remarks) }}">

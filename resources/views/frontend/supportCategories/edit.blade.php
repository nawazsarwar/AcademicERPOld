                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.support-categories.update", [$supportCategory->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="color" id="color" value="{{ old('color', $supportCategory->color) }}" required>
                            @if($errors->has('color'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('color') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="remarks" id="remarks" value="{{ old('remarks', $supportCategory->remarks) }}">

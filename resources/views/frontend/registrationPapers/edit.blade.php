        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.edit') }} {{ trans('cruds.registrationPaper.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.registration-papers.update", [$registrationPaper->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="paper_id" id="paper_id" required>
                                @foreach($papers as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('paper_id') ? old('paper_id') : $registrationPaper->paper->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('paper'))
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="registration_id" id="registration_id" required>
                                @foreach($registrations as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('registration_id') ? old('registration_id') : $registrationPaper->registration->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="student_id" id="student_id" required>
                                @foreach($students as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('student_id') ? old('student_id') : $registrationPaper->student->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\RegistrationPaper::MODE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="mode_{{ $key }}" name="mode" value="{{ $key }}" {{ old('mode', $registrationPaper->mode) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="profile" id="profile">{{ old('profile', $registrationPaper->profile) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="faculty" id="faculty" value="{{ old('faculty', $registrationPaper->faculty) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="department" id="department" value="{{ old('department', $registrationPaper->department) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="department_code" id="department_code" value="{{ old('department_code', $registrationPaper->department_code) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="paper_code" id="paper_code" value="{{ old('paper_code', $registrationPaper->paper_code) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="paper_title" id="paper_title" value="{{ old('paper_title', $registrationPaper->paper_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="part" id="part" value="{{ old('part', $registrationPaper->part) }}" step="1">
                            @if($errors->has('part'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('part') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="credits" id="credits" value="{{ old('credits', $registrationPaper->credits) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="status" id="status" value="{{ old('status', $registrationPaper->status) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks">{{ old('remarks', $registrationPaper->remarks) }}</textarea>

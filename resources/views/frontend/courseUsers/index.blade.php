        ...
        <div class="col-md-12">
            @can('course_user_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.course-users.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $courseUser->id }}">
                                        ...
                                        <td>
                                            @can('course_user_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.course-users.show', $courseUser->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('course_user_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.course-users.edit', $courseUser->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('course_user_delete')
                                                <form action="{{ route('frontend.course-users.destroy', $courseUser->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('course_user_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.course-users.massDestroy') }}",

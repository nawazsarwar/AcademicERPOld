    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.course-users.update", [$courseUser->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="faculty_no" id="faculty_no" value="{{ old('faculty_no', $courseUser->faculty_no) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="admitted_on" id="admitted_on" value="{{ old('admitted_on', $courseUser->admitted_on) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="duration_extension" id="duration_extension" value="{{ old('duration_extension', $courseUser->duration_extension) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="verified_at" id="verified_at" value="{{ old('verified_at', $courseUser->verified_at) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="verification_remark" id="verification_remark">{{ old('verification_remark', $courseUser->verification_remark) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="status" id="status" value="{{ old('status', $courseUser->status) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks">{{ old('remarks', $courseUser->remarks) }}</textarea>

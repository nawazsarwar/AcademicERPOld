    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.reevaluations.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="examination_name" id="examination_name" value="{{ old('examination_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="examination_year" id="examination_year" value="{{ old('examination_year', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="examination_part" id="examination_part" value="{{ old('examination_part', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="result_declaration_date" id="result_declaration_date" value="{{ old('result_declaration_date') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="submitted" id="submitted" value="{{ old('submitted', '') }}" step="1">

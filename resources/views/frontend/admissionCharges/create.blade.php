    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.admission-charges.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="boys_nr_internal" id="boys_nr_internal" value="{{ old('boys_nr_internal', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="boys_resident_external" id="boys_resident_external" value="{{ old('boys_resident_external', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="boys_resident_internal" id="boys_resident_internal" value="{{ old('boys_resident_internal', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="girls_nr_external" id="girls_nr_external" value="{{ old('girls_nr_external', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="girls_nr_internal" id="girls_nr_internal" value="{{ old('girls_nr_internal', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="girls_resident_external" id="girls_resident_external" value="{{ old('girls_resident_external', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="girls_resident_internal" id="girls_resident_internal" value="{{ old('girls_resident_internal', '') }}" step="0.01">

            ...
            @can('support_ticket_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        ...
                        @include('csvImport.modal', ['model' => 'SupportTicket', 'route' => 'admin.support-tickets.parseCsvImport'])
                    </div>
                </div>
            @endcan
            <div class="card">
                        ...
                        <table class=" table table-bordered table-striped table-hover datatable datatable-SupportTicket">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        {{ trans('cruds.supportTicket.fields.attachments') }}
                                    </th>
                                    <th>
                            ...
                            <tbody>
                                @foreach($supportTickets as $key => $supportTicket)
                                    <tr data-entry-id="{{ $supportTicket->id }}">
                                        ...
                                        <td>
                                            @foreach($supportTicket->attachments as $key => $media)

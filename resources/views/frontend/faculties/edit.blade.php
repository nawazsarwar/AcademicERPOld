                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.faculties.update", [$faculty->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="color" id="color" value="{{ old('color', $faculty->color) }}">
                            @if($errors->has('color'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('color') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="status" id="status" value="{{ old('status', $faculty->status) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks">{{ old('remarks', $faculty->remarks) }}</textarea>

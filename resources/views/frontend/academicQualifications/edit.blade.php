                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.academic-qualifications.update", [$academicQualification->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $academicQualification->name) }}" required>
                            @if($errors->has('name'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('name') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="year" id="year" value="{{ old('year', $academicQualification->year) }}" step="1" required>
                            @if($errors->has('year'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('year') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="roll_no" id="roll_no" value="{{ old('roll_no', $academicQualification->roll_no) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="grade" id="grade" value="{{ old('grade', $academicQualification->grade) }}">
                            @if($errors->has('grade'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('grade') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cdn_url" id="cdn_url" value="{{ old('cdn_url', $academicQualification->cdn_url) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="status" id="status" value="{{ old('status', $academicQualification->status) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks">{{ old('remarks', $academicQualification->remarks) }}</textarea>

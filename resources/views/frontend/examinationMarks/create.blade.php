                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.examination-marks.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="entered_at" id="entered_at" value="{{ old('entered_at') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="result_declaration_date" id="result_declaration_date" value="{{ old('result_declaration_date') }}">

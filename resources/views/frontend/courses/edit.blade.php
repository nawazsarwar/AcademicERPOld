                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.courses.update", [$course->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title_hindi" id="title_hindi" value="{{ old('title_hindi', $course->title_hindi) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title_urdu" id="title_urdu" value="{{ old('title_urdu', $course->title_urdu) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="code" id="code" value="{{ old('code', $course->code) }}" required>
                            @if($errors->has('code'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('code') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="internal_code" id="internal_code" value="{{ old('internal_code', $course->internal_code) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="duration" id="duration" value="{{ old('duration', $course->duration) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_intake" id="total_intake" value="{{ old('total_intake', $course->total_intake) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Course::SUBSIDIARIZABLE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="subsidiarizable_{{ $key }}" name="subsidiarizable" value="{{ $key }}" {{ old('subsidiarizable', $course->subsidiarizable) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="administrable_type" id="administrable_type" value="{{ old('administrable_type', $course->administrable_type) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks">{{ old('remarks', $course->remarks) }}</textarea>

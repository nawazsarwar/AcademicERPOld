                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.students.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="enrolment_no" id="enrolment_no" value="{{ old('enrolment_no', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="guardians_mobile_no" id="guardians_mobile_no" value="{{ old('guardians_mobile_no', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="emergency_mobile_no" id="emergency_mobile_no" value="{{ old('emergency_mobile_no', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="detained" id="detained" value="{{ old('detained', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="detention_reason" id="detention_reason">{{ old('detention_reason') }}</textarea>

        ...
        <div class="col-md-12">
            @can('answer_script_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.answer-scripts.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $answerScript->id }}">
                                        ...
                                        <td>
                                            @can('answer_script_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.answer-scripts.show', $answerScript->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('answer_script_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.answer-scripts.edit', $answerScript->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('answer_script_delete')
                                                <form action="{{ route('frontend.answer-scripts.destroy', $answerScript->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('answer_script_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.answer-scripts.massDestroy') }}",

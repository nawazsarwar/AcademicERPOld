    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.answer-scripts.update", [$answerScript->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="page_no" id="page_no" value="{{ old('page_no', $answerScript->page_no) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="file_path" id="file_path" value="{{ old('file_path', $answerScript->file_path) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="extension" id="extension" value="{{ old('extension', $answerScript->extension) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="file_url" id="file_url" value="{{ old('file_url', $answerScript->file_url) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cdn_url" id="cdn_url" value="{{ old('cdn_url', $answerScript->cdn_url) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="status" id="status" value="{{ old('status', $answerScript->status) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks">{{ old('remarks', $answerScript->remarks) }}</textarea>

                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.work-experiences.update", [$workExperience->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="employed_from" id="employed_from" value="{{ old('employed_from', $workExperience->employed_from) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="employed_to" id="employed_to" value="{{ old('employed_to', $workExperience->employed_to) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="reason_for_leaving" id="reason_for_leaving" value="{{ old('reason_for_leaving', $workExperience->reason_for_leaving) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pay_band" id="pay_band" value="{{ old('pay_band', $workExperience->pay_band) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="basic_pay" id="basic_pay" value="{{ old('basic_pay', $workExperience->basic_pay) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="gross_pay" id="gross_pay" value="{{ old('gross_pay', $workExperience->gross_pay) }}">

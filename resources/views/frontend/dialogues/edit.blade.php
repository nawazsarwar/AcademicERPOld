                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.dialogues.update", [$dialogue->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pingback_url" id="pingback_url" value="{{ old('pingback_url', $dialogue->pingback_url) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="request_type" id="request_type" value="{{ old('request_type', $dialogue->request_type) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="raw_response" id="raw_response">{{ old('raw_response', $dialogue->raw_response) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="response" id="response">{{ old('response', $dialogue->response) }}</textarea>

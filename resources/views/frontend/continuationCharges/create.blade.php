    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.continuation-charges.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="nr_first_installment" id="nr_first_installment" value="{{ old('nr_first_installment', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="nr_second_installment" id="nr_second_installment" value="{{ old('nr_second_installment', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="resident_total" id="resident_total" value="{{ old('resident_total', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="resident_first_installment" id="resident_first_installment" value="{{ old('resident_first_installment', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="resident_second_installment" id="resident_second_installment" value="{{ old('resident_second_installment', '') }}" step="0.01">

                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.employees.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="employee_no" id="employee_no" value="{{ old('employee_no', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="service_book_no" id="service_book_no" value="{{ old('service_book_no', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="application_no" id="application_no" value="{{ old('application_no', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="highest_qualification" id="highest_qualification" value="{{ old('highest_qualification', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="leave_account_no" id="leave_account_no" value="{{ old('leave_account_no', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pf_account_no" id="pf_account_no" value="{{ old('pf_account_no', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="personal_file_no" id="personal_file_no" value="{{ old('personal_file_no', '') }}">

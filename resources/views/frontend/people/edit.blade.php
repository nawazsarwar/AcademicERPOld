                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.people.update", [$person->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="first_name" id="first_name" value="{{ old('first_name', $person->first_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="middle_name" id="middle_name" value="{{ old('middle_name', $person->middle_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="last_name" id="last_name" value="{{ old('last_name', $person->last_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="fathers_first_name" id="fathers_first_name" value="{{ old('fathers_first_name', $person->fathers_first_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="fathers_middle_name" id="fathers_middle_name" value="{{ old('fathers_middle_name', $person->fathers_middle_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="fathers_last_name" id="fathers_last_name" value="{{ old('fathers_last_name', $person->fathers_last_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mothers_first_name" id="mothers_first_name" value="{{ old('mothers_first_name', $person->mothers_first_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mothers_middle_name" id="mothers_middle_name" value="{{ old('mothers_middle_name', $person->mothers_middle_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mothers_last_name" id="mothers_last_name" value="{{ old('mothers_last_name', $person->mothers_last_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="aadhaar_no" id="aadhaar_no" value="{{ old('aadhaar_no', $person->aadhaar_no) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sub_caste" id="sub_caste" value="{{ old('sub_caste', $person->sub_caste) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="identity_marks" id="identity_marks" value="{{ old('identity_marks', $person->identity_marks) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="dob_proof" id="dob_proof" value="{{ old('dob_proof', $person->dob_proof) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="spouse_name" id="spouse_name" value="{{ old('spouse_name', $person->spouse_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pan_no" id="pan_no" value="{{ old('pan_no', $person->pan_no) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="passport_no" id="passport_no" value="{{ old('passport_no', $person->passport_no) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="status" id="status" value="{{ old('status', $person->status) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks">{{ old('remarks', $person->remarks) }}</textarea>

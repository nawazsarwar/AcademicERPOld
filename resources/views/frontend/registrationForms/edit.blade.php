    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.registration-forms.update", [$registrationForm->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $registrationForm->title) }}" required>
                            @if($errors->has('title'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('title') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="opening_date" id="opening_date" value="{{ old('opening_date', $registrationForm->opening_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="closing_date" id="closing_date" value="{{ old('closing_date', $registrationForm->closing_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\RegistrationForm::FILLABLE_CURRENT_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="fillable_current_{{ $key }}" name="fillable_current" value="{{ $key }}" {{ old('fillable_current', $registrationForm->fillable_current) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\RegistrationForm::FILLABLE_BACKLOG_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="fillable_backlog_{{ $key }}" name="fillable_backlog" value="{{ $key }}" {{ old('fillable_backlog', $registrationForm->fillable_backlog) === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="status" id="status" value="{{ old('status', $registrationForm->status) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks">{{ old('remarks', $registrationForm->remarks) }}</textarea>

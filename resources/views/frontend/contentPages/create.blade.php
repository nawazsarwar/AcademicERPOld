                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.content-pages.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="website_id" id="website_id" required>
                                @foreach($websites as $id => $entry)
                                    <option value="{{ $id }}" {{ old('website_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="approved" id="approved" value="{{ old('approved', '0') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="deleted_by_id" id="deleted_by_id">
                                @foreach($deleted_bies as $id => $entry)
                                    <option value="{{ $id }}" {{ old('deleted_by_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="publish_at" id="publish_at" value="{{ old('publish_at') }}">

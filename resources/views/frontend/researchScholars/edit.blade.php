    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.research-scholars.update", [$researchScholar->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="admission_date" id="admission_date" value="{{ old('admission_date', $researchScholar->admission_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="supervisor_name" id="supervisor_name" value="{{ old('supervisor_name', $researchScholar->supervisor_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="co_supervisor_name" id="co_supervisor_name" value="{{ old('co_supervisor_name', $researchScholar->co_supervisor_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="co_supervisor_address" id="co_supervisor_address">{{ old('co_supervisor_address', $researchScholar->co_supervisor_address) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="research_topic" id="research_topic" value="{{ old('research_topic', $researchScholar->research_topic) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="bos_date" id="bos_date" value="{{ old('bos_date', $researchScholar->bos_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="casr_date" id="casr_date" value="{{ old('casr_date', $researchScholar->casr_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="paper_1" id="paper_1" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="paper_1_result" id="paper_1_result" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="paper_2" id="paper_2" value="{{ old('paper_2', $researchScholar->paper_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="paper_3" id="paper_3" value="{{ old('paper_3', $researchScholar->paper_3) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="paper_4" id="paper_4" value="{{ old('paper_4', $researchScholar->paper_4) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="pre_submission_date" id="pre_submission_date" value="{{ old('pre_submission_date', $researchScholar->pre_submission_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="submission_date" id="submission_date" value="{{ old('submission_date', $researchScholar->submission_date) }}">

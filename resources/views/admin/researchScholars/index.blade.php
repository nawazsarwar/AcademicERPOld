...
@can('research_scholar_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.research-scholars.create') }}">
                        ...
                        <tr data-entry-id="{{ $researchScholar->id }}">
                            ...
                            <td>
                                @can('research_scholar_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.research-scholars.show', $researchScholar->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('research_scholar_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.research-scholars.edit', $researchScholar->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('research_scholar_delete')
                                    <form action="{{ route('admin.research-scholars.destroy', $researchScholar->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('research_scholar_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.research-scholars.massDestroy') }}",

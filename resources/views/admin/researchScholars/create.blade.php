...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.research-scholars.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('supervisor_name') ? 'is-invalid' : '' }}" type="text" name="supervisor_name" id="supervisor_name" value="{{ old('supervisor_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('co_supervisor_name') ? 'is-invalid' : '' }}" type="text" name="co_supervisor_name" id="co_supervisor_name" value="{{ old('co_supervisor_name', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('co_supervisor_address') ? 'is-invalid' : '' }}" name="co_supervisor_address" id="co_supervisor_address">{{ old('co_supervisor_address') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('research_topic') ? 'is-invalid' : '' }}" type="text" name="research_topic" id="research_topic" value="{{ old('research_topic', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('bos_date') ? 'is-invalid' : '' }}" type="text" name="bos_date" id="bos_date" value="{{ old('bos_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('casr_date') ? 'is-invalid' : '' }}" type="text" name="casr_date" id="casr_date" value="{{ old('casr_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('paper_2') ? 'is-invalid' : '' }}" type="text" name="paper_2" id="paper_2" value="{{ old('paper_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('paper_3') ? 'is-invalid' : '' }}" type="text" name="paper_3" id="paper_3" value="{{ old('paper_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('paper_4') ? 'is-invalid' : '' }}" type="text" name="paper_4" id="paper_4" value="{{ old('paper_4', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('pre_submission_date') ? 'is-invalid' : '' }}" type="text" name="pre_submission_date" id="pre_submission_date" value="{{ old('pre_submission_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('submission_date') ? 'is-invalid' : '' }}" type="text" name="submission_date" id="submission_date" value="{{ old('submission_date') }}">

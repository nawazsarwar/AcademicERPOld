    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.receivables.update", [$receivable->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('narration') ? 'is-invalid' : '' }}" type="text" name="narration" id="narration" value="{{ old('narration', $receivable->narration) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $receivable->description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('raised_on') ? 'is-invalid' : '' }}" type="text" name="raised_on" id="raised_on" value="{{ old('raised_on', $receivable->raised_on) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('settlement_status') ? 'is-invalid' : '' }}" type="text" name="settlement_status" id="settlement_status" value="{{ old('settlement_status', $receivable->settlement_status) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('settled_on') ? 'is-invalid' : '' }}" type="text" name="settled_on" id="settled_on" value="{{ old('settled_on', $receivable->settled_on) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" name="remarks" id="remarks">{{ old('remarks', $receivable->remarks) }}</textarea>

    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.merchants.update", [$merchant->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('uid') ? 'is-invalid' : '' }}" type="text" name="uid" id="uid" value="{{ old('uid', $merchant->uid) }}" required>
                @if($errors->has('uid'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('parameters') ? 'is-invalid' : '' }}" name="parameters" id="parameters" required>{{ old('parameters', $merchant->parameters) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account') ? 'is-invalid' : '' }}" type="text" name="account" id="account" value="{{ old('account', $merchant->account) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" name="remarks" id="remarks">{{ old('remarks', $merchant->remarks) }}</textarea>

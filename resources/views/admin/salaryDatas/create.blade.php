...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.salaryData.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.salary-datas.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ecode') ? 'is-invalid' : '' }}" type="text" name="ecode" id="ecode" value="{{ old('ecode', '') }}" required>
                @if($errors->has('ecode'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('basic') ? 'is-invalid' : '' }}" type="number" name="basic" id="basic" value="{{ old('basic', '') }}" step="0.01">
                @if($errors->has('basic'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('desig_name') ? 'is-invalid' : '' }}" type="text" name="desig_name" id="desig_name" value="{{ old('desig_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emp_status') ? 'is-invalid' : '' }}" type="text" name="emp_status" id="emp_status" value="{{ old('emp_status', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('date_of_join') ? 'is-invalid' : '' }}" type="text" name="date_of_join" id="date_of_join" value="{{ old('date_of_join', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('date_of_birth') ? 'is-invalid' : '' }}" type="text" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('retire_date') ? 'is-invalid' : '' }}" type="text" name="retire_date" id="retire_date" value="{{ old('retire_date', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pf_type') ? 'is-invalid' : '' }}" type="text" name="pf_type" id="pf_type" value="{{ old('pf_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emp_grop') ? 'is-invalid' : '' }}" type="text" name="emp_grop" id="emp_grop" value="{{ old('emp_grop', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('leave') ? 'is-invalid' : '' }}" type="text" name="leave" id="leave" value="{{ old('leave', '') }}">
                @if($errors->has('leave'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('designation_category') ? 'is-invalid' : '' }}" type="text" name="designation_category" id="designation_category" value="{{ old('designation_category', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('exists_cc') ? 'is-invalid' : '' }}" type="number" name="exists_cc" id="exists_cc" value="{{ old('exists_cc', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('import_date') ? 'is-invalid' : '' }}" type="text" name="import_date" id="import_date" value="{{ old('import_date') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('salary_month') ? 'is-invalid' : '' }}" type="text" name="salary_month" id="salary_month" value="{{ old('salary_month', '') }}">

...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.family-members.update", [$familyMember->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('submission_date') ? 'is-invalid' : '' }}" type="text" name="submission_date" id="submission_date" value="{{ old('submission_date', $familyMember->submission_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('family_member_name') ? 'is-invalid' : '' }}" type="text" name="family_member_name" id="family_member_name" value="{{ old('family_member_name', $familyMember->family_member_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dob') ? 'is-invalid' : '' }}" type="text" name="dob" id="dob" value="{{ old('dob', $familyMember->dob) }}">
                @if($errors->has('dob'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('relationship') ? 'is-invalid' : '' }}" type="text" name="relationship" id="relationship" value="{{ old('relationship', $familyMember->relationship) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('marital_status') ? 'is-invalid' : '' }}" type="text" name="marital_status" id="marital_status" value="{{ old('marital_status', $familyMember->marital_status) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="number" name="status" id="status" value="{{ old('status', $familyMember->status) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" type="text" name="remarks" id="remarks" value="{{ old('remarks', $familyMember->remarks) }}">

    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.employees.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('service_book_no') ? 'is-invalid' : '' }}" type="text" name="service_book_no" id="service_book_no" value="{{ old('service_book_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('application_no') ? 'is-invalid' : '' }}" type="text" name="application_no" id="application_no" value="{{ old('application_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('highest_qualification') ? 'is-invalid' : '' }}" type="text" name="highest_qualification" id="highest_qualification" value="{{ old('highest_qualification', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('status_date') ? 'is-invalid' : '' }}" type="text" name="status_date" id="status_date" value="{{ old('status_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('leave_account_no') ? 'is-invalid' : '' }}" type="text" name="leave_account_no" id="leave_account_no" value="{{ old('leave_account_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pf_account_no') ? 'is-invalid' : '' }}" type="text" name="pf_account_no" id="pf_account_no" value="{{ old('pf_account_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('personal_file_no') ? 'is-invalid' : '' }}" type="text" name="personal_file_no" id="personal_file_no" value="{{ old('personal_file_no', '') }}">

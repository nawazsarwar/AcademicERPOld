    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.clients.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('return_url') ? 'is-invalid' : '' }}" type="text" name="return_url" id="return_url" value="{{ old('return_url', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('timeout') ? 'is-invalid' : '' }}" type="number" name="timeout" id="timeout" value="{{ old('timeout', '') }}" step="1" required>

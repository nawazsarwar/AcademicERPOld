...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.answer-scripts.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('page_no') ? 'is-invalid' : '' }}" type="number" name="page_no" id="page_no" value="{{ old('page_no', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('file_path') ? 'is-invalid' : '' }}" type="text" name="file_path" id="file_path" value="{{ old('file_path', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('extension') ? 'is-invalid' : '' }}" type="text" name="extension" id="extension" value="{{ old('extension', '') }}" required>

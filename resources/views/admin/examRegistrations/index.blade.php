...
@can('exam_registration_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.exam-registrations.create') }}">
                        ...
                        <tr data-entry-id="{{ $examRegistration->id }}">
                            ...
                            <td>
                                @can('exam_registration_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.exam-registrations.show', $examRegistration->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('exam_registration_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.exam-registrations.edit', $examRegistration->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('exam_registration_delete')
                                    <form action="{{ route('admin.exam-registrations.destroy', $examRegistration->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('exam_registration_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.exam-registrations.massDestroy') }}",

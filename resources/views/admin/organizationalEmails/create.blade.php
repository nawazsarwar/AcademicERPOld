...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.organizationalEmail.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.organizational-emails.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alias') ? 'is-invalid' : '' }}" type="email" name="alias" id="alias" value="{{ old('alias') }}">
                @if($errors->has('alias'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('first_password') ? 'is-invalid' : '' }}" type="text" name="first_password" id="first_password" value="{{ old('first_password', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('recovery_email') ? 'is-invalid' : '' }}" type="email" name="recovery_email" id="recovery_email" value="{{ old('recovery_email') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('recovery_phone') ? 'is-invalid' : '' }}" type="text" name="recovery_phone" id="recovery_phone" value="{{ old('recovery_phone', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('office_365') ? 'is-invalid' : '' }}" type="number" name="office_365" id="office_365" value="{{ old('office_365', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('office_365_uid') ? 'is-invalid' : '' }}" type="text" name="office_365_uid" id="office_365_uid" value="{{ old('office_365_uid', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('office_365_object_uid') ? 'is-invalid' : '' }}" type="text" name="office_365_object_uid" id="office_365_object_uid" value="{{ old('office_365_object_uid', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('office_365_deployed_at') ? 'is-invalid' : '' }}" type="text" name="office_365_deployed_at" id="office_365_deployed_at" value="{{ old('office_365_deployed_at') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gsuite') ? 'is-invalid' : '' }}" type="number" name="gsuite" id="gsuite" value="{{ old('gsuite', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gsuite_uid') ? 'is-invalid' : '' }}" type="text" name="gsuite_uid" id="gsuite_uid" value="{{ old('gsuite_uid', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('gsuite_deployed_at') ? 'is-invalid' : '' }}" type="text" name="gsuite_deployed_at" id="gsuite_deployed_at" value="{{ old('gsuite_deployed_at') }}">

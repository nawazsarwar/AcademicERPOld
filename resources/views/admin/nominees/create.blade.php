...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.nominees.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('witness_name_1') ? 'is-invalid' : '' }}" type="text" name="witness_name_1" id="witness_name_1" value="{{ old('witness_name_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('designation_witness_1') ? 'is-invalid' : '' }}" type="text" name="designation_witness_1" id="designation_witness_1" value="{{ old('designation_witness_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('department_witness_1') ? 'is-invalid' : '' }}" type="text" name="department_witness_1" id="department_witness_1" value="{{ old('department_witness_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('witness_name_2') ? 'is-invalid' : '' }}" type="text" name="witness_name_2" id="witness_name_2" value="{{ old('witness_name_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('designation_witness_2') ? 'is-invalid' : '' }}" type="text" name="designation_witness_2" id="designation_witness_2" value="{{ old('designation_witness_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('department_witness_2') ? 'is-invalid' : '' }}" type="text" name="department_witness_2" id="department_witness_2" value="{{ old('department_witness_2', '') }}">

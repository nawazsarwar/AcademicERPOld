...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.continuationCharge.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.continuation-charges.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nr_total') ? 'is-invalid' : '' }}" type="number" name="nr_total" id="nr_total" value="{{ old('nr_total', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nr_first_installment') ? 'is-invalid' : '' }}" type="number" name="nr_first_installment" id="nr_first_installment" value="{{ old('nr_first_installment', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nr_second_installment') ? 'is-invalid' : '' }}" type="number" name="nr_second_installment" id="nr_second_installment" value="{{ old('nr_second_installment', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('resident_total') ? 'is-invalid' : '' }}" type="number" name="resident_total" id="resident_total" value="{{ old('resident_total', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('resident_first_installment') ? 'is-invalid' : '' }}" type="number" name="resident_first_installment" id="resident_first_installment" value="{{ old('resident_first_installment', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('resident_second_installment') ? 'is-invalid' : '' }}" type="number" name="resident_second_installment" id="resident_second_installment" value="{{ old('resident_second_installment', '') }}" step="0.01">

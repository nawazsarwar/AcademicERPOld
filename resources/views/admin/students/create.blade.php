    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.students.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('guardians_mobile_no') ? 'is-invalid' : '' }}" type="text" name="guardians_mobile_no" id="guardians_mobile_no" value="{{ old('guardians_mobile_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emergency_mobile_no') ? 'is-invalid' : '' }}" type="text" name="emergency_mobile_no" id="emergency_mobile_no" value="{{ old('emergency_mobile_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('detained') ? 'is-invalid' : '' }}" type="number" name="detained" id="detained" value="{{ old('detained', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('detention_reason') ? 'is-invalid' : '' }}" name="detention_reason" id="detention_reason">{{ old('detention_reason') }}</textarea>

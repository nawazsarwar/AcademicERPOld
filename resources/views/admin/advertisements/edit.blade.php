    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.advertisements.update", [$advertisement->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug" id="slug" value="{{ old('slug', $advertisement->slug) }}" required>
                @if($errors->has('slug'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dated') ? 'is-invalid' : '' }}" type="text" name="dated" id="dated" value="{{ old('dated', $advertisement->dated) }}" required>
                @if($errors->has('dated'))

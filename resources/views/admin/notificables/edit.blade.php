...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.notificables.update", [$notificable->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('notificable') ? 'is-invalid' : '' }}" type="number" name="notificable" id="notificable" value="{{ old('notificable', $notificable->notificable) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('notificable_type') ? 'is-invalid' : '' }}" type="text" name="notificable_type" id="notificable_type" value="{{ old('notificable_type', $notificable->notificable_type) }}" required>

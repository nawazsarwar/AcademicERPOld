    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.examination-marks.update", [$examinationMark->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('season') ? 'is-invalid' : '' }}" type="text" name="season" id="season" value="{{ old('season', $examinationMark->season) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('entered_at') ? 'is-invalid' : '' }}" type="text" name="entered_at" id="entered_at" value="{{ old('entered_at', $examinationMark->entered_at) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('verified_at') ? 'is-invalid' : '' }}" type="text" name="verified_at" id="verified_at" value="{{ old('verified_at', $examinationMark->verified_at) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('result_declaration_date') ? 'is-invalid' : '' }}" type="text" name="result_declaration_date" id="result_declaration_date" value="{{ old('result_declaration_date', $examinationMark->result_declaration_date) }}">

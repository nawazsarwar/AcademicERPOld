...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.organizationUnit.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.organization-units.update", [$organizationUnit->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.organizationUnit.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $organizationUnit->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" type="text" name="code" id="code" value="{{ old('code', $organizationUnit->code) }}">
                @if($errors->has('code'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_hindi') ? 'is-invalid' : '' }}" type="text" name="title_hindi" id="title_hindi" value="{{ old('title_hindi', $organizationUnit->title_hindi) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_urdu') ? 'is-invalid' : '' }}" type="text" name="title_urdu" id="title_urdu" value="{{ old('title_urdu', $organizationUnit->title_urdu) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('category') ? 'is-invalid' : '' }}" type="text" name="category" id="category" value="{{ old('category', $organizationUnit->category) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text" name="status" id="status" value="{{ old('status', $organizationUnit->status) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" name="remarks" id="remarks">{{ old('remarks', $organizationUnit->remarks) }}</textarea>

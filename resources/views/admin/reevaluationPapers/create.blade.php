...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.reevaluation-papers.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('paper_code') ? 'is-invalid' : '' }}" type="text" name="paper_code" id="paper_code" value="{{ old('paper_code', '') }}" required>

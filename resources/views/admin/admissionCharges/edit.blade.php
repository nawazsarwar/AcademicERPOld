...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.admission-charges.update", [$admissionCharge->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" type="text" name="code" id="code" value="{{ old('code', $admissionCharge->code) }}">
                @if($errors->has('code'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('boys_nr_external') ? 'is-invalid' : '' }}" type="number" name="boys_nr_external" id="boys_nr_external" value="{{ old('boys_nr_external', $admissionCharge->boys_nr_external) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('boys_nr_internal') ? 'is-invalid' : '' }}" type="number" name="boys_nr_internal" id="boys_nr_internal" value="{{ old('boys_nr_internal', $admissionCharge->boys_nr_internal) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('boys_resident_external') ? 'is-invalid' : '' }}" type="number" name="boys_resident_external" id="boys_resident_external" value="{{ old('boys_resident_external', $admissionCharge->boys_resident_external) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('boys_resident_internal') ? 'is-invalid' : '' }}" type="number" name="boys_resident_internal" id="boys_resident_internal" value="{{ old('boys_resident_internal', $admissionCharge->boys_resident_internal) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('girls_nr_external') ? 'is-invalid' : '' }}" type="number" name="girls_nr_external" id="girls_nr_external" value="{{ old('girls_nr_external', $admissionCharge->girls_nr_external) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('girls_nr_internal') ? 'is-invalid' : '' }}" type="number" name="girls_nr_internal" id="girls_nr_internal" value="{{ old('girls_nr_internal', $admissionCharge->girls_nr_internal) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('girls_resident_external') ? 'is-invalid' : '' }}" type="number" name="girls_resident_external" id="girls_resident_external" value="{{ old('girls_resident_external', $admissionCharge->girls_resident_external) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('girls_resident_internal') ? 'is-invalid' : '' }}" type="number" name="girls_resident_internal" id="girls_resident_internal" value="{{ old('girls_resident_internal', $admissionCharge->girls_resident_internal) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text" name="status" id="status" value="{{ old('status', $admissionCharge->status) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" name="remarks" id="remarks">{{ old('remarks', $admissionCharge->remarks) }}</textarea>

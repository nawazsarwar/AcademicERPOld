    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.admission-charges.update", [$admissionCharge->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('girls_nr_internal') ? 'is-invalid' : '' }}" type="text" name="girls_nr_internal" id="girls_nr_internal" value="{{ old('girls_nr_internal', $admissionCharge->girls_nr_internal) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('girls_resident_internal') ? 'is-invalid' : '' }}" type="text" name="girls_resident_internal" id="girls_resident_internal" value="{{ old('girls_resident_internal', $admissionCharge->girls_resident_internal) }}">

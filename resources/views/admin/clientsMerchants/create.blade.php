...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.clients-merchants.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sub_head') ? 'is-invalid' : '' }}" type="text" name="sub_head" id="sub_head" value="{{ old('sub_head', '') }}">

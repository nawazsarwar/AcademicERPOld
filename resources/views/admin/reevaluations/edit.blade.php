...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.reevaluations.update", [$reevaluation->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('examination_name') ? 'is-invalid' : '' }}" type="text" name="examination_name" id="examination_name" value="{{ old('examination_name', $reevaluation->examination_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('examination_year') ? 'is-invalid' : '' }}" type="text" name="examination_year" id="examination_year" value="{{ old('examination_year', $reevaluation->examination_year) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('examination_part') ? 'is-invalid' : '' }}" type="text" name="examination_part" id="examination_part" value="{{ old('examination_part', $reevaluation->examination_part) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('result_declaration_date') ? 'is-invalid' : '' }}" type="text" name="result_declaration_date" id="result_declaration_date" value="{{ old('result_declaration_date', $reevaluation->result_declaration_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('submitted') ? 'is-invalid' : '' }}" type="number" name="submitted" id="submitted" value="{{ old('submitted', $reevaluation->submitted) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text" name="status" id="status" value="{{ old('status', $reevaluation->status) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" name="remarks" id="remarks">{{ old('remarks', $reevaluation->remarks) }}</textarea>

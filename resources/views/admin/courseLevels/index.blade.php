...
@can('course_level_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.course-levels.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-CourseLevel">
            <thead>
                <tr>
                    <th width="10">
...
@can('course_level_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.course-levels.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.course-levels.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-CourseLevel').DataTable(dtOverrideGlobals);

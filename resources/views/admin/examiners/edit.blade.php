...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.examiners.update", [$examiner->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $examiner->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('institute') ? 'is-invalid' : '' }}" type="text" name="institute" id="institute" value="{{ old('institute', $examiner->institute) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('department') ? 'is-invalid' : '' }}" type="text" name="department" id="department" value="{{ old('department', $examiner->department) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" type="text" name="mobile" id="mobile" value="{{ old('mobile', $examiner->mobile) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $examiner->email) }}" required>
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('otp') ? 'is-invalid' : '' }}" type="text" name="otp" id="otp" value="{{ old('otp', $examiner->otp) }}">
                @if($errors->has('otp'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('otp_validity') ? 'is-invalid' : '' }}" type="text" name="otp_validity" id="otp_validity" value="{{ old('otp_validity', $examiner->otp_validity) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('otp_verified') ? 'is-invalid' : '' }}" type="number" name="otp_verified" id="otp_verified" value="{{ old('otp_verified', $examiner->otp_verified) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('start') ? 'is-invalid' : '' }}" type="text" name="start" id="start" value="{{ old('start', $examiner->start) }}">
                @if($errors->has('start'))
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('end') ? 'is-invalid' : '' }}" type="text" name="end" id="end" value="{{ old('end', $examiner->end) }}">
                @if($errors->has('end'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" name="remarks" id="remarks">{{ old('remarks', $examiner->remarks) }}</textarea>

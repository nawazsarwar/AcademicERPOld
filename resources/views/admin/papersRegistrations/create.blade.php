...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.papers-registrations.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\PapersRegistration::REGISTRATION_MODE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('registration_mode') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="registration_mode_{{ $key }}" name="registration_mode" value="{{ $key }}" {{ old('registration_mode', '') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('profile') ? 'is-invalid' : '' }}" name="profile" id="profile">{{ old('profile') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('department_code') ? 'is-invalid' : '' }}" type="text" name="department_code" id="department_code" value="{{ old('department_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('paper_code') ? 'is-invalid' : '' }}" type="text" name="paper_code" id="paper_code" value="{{ old('paper_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('paper_title') ? 'is-invalid' : '' }}" type="text" name="paper_title" id="paper_title" value="{{ old('paper_title', '') }}">

...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.hostel-rooms.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vacancy') ? 'is-invalid' : '' }}" type="number" name="vacancy" id="vacancy" value="{{ old('vacancy', '0') }}" step="1" required>

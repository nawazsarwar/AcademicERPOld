...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.computerCentreData.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.computer-centre-datas.update", [$computerCentreData->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="uri">{{ trans('cruds.computerCentreData.fields.uri') }}</label>
                <input class="form-control {{ $errors->has('uri') ? 'is-invalid' : '' }}" type="text" name="uri" id="uri" value="{{ old('uri', $computerCentreData->uri) }}" required>
                @if($errors->has('uri'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug" id="slug" value="{{ old('slug', $computerCentreData->slug) }}">
                @if($errors->has('slug'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" type="text" name="type" id="type" value="{{ old('type', $computerCentreData->type) }}">
                @if($errors->has('type'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parser') ? 'is-invalid' : '' }}" type="text" name="parser" id="parser" value="{{ old('parser', $computerCentreData->parser) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('data') ? 'is-invalid' : '' }}" name="data" id="data">{{ old('data', $computerCentreData->data) }}</textarea>
                @if($errors->has('data'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parent') ? 'is-invalid' : '' }}" type="number" name="parent" id="parent" value="{{ old('parent', $computerCentreData->parent) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('crawled') ? 'is-invalid' : '' }}" type="number" name="crawled" id="crawled" value="{{ old('crawled', $computerCentreData->crawled) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('last_crawled_at') ? 'is-invalid' : '' }}" type="text" name="last_crawled_at" id="last_crawled_at" value="{{ old('last_crawled_at', $computerCentreData->last_crawled_at) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" name="remarks" id="remarks">{{ old('remarks', $computerCentreData->remarks) }}</textarea>

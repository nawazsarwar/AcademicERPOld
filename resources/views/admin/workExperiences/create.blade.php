    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.work-experiences.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('employed_from') ? 'is-invalid' : '' }}" type="text" name="employed_from" id="employed_from" value="{{ old('employed_from') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('employed_to') ? 'is-invalid' : '' }}" type="text" name="employed_to" id="employed_to" value="{{ old('employed_to') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pay_band') ? 'is-invalid' : '' }}" type="text" name="pay_band" id="pay_band" value="{{ old('pay_band', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gross_pay') ? 'is-invalid' : '' }}" type="text" name="gross_pay" id="gross_pay" value="{{ old('gross_pay', '') }}">

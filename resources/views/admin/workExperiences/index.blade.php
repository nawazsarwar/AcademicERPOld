                        ...
                        <tr data-entry-id="{{ $workExperience->id }}">
                            ...
                            <td>
                                @can('work_experience_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.work-experiences.show', $workExperience->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('work_experience_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.work-experiences.edit', $workExperience->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('work_experience_delete')
                                    <form action="{{ route('admin.work-experiences.destroy', $workExperience->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">

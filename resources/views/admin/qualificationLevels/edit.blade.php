    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.qualification-levels.update", [$qualificationLevel->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="number" name="status" id="status" value="{{ old('status', $qualificationLevel->status) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" type="text" name="remarks" id="remarks" value="{{ old('remarks', $qualificationLevel->remarks) }}">

...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.hall-students.update", [$hallStudent->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('room_no') ? 'is-invalid' : '' }}" type="text" name="room_no" id="room_no" value="{{ old('room_no', $hallStudent->room_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('allotment_date') ? 'is-invalid' : '' }}" type="text" name="allotment_date" id="allotment_date" value="{{ old('allotment_date', $hallStudent->allotment_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('allotted_on') ? 'is-invalid' : '' }}" type="text" name="allotted_on" id="allotted_on" value="{{ old('allotted_on', $hallStudent->allotted_on) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text" name="status" id="status" value="{{ old('status', $hallStudent->status) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" name="remarks" id="remarks">{{ old('remarks', $hallStudent->remarks) }}</textarea>

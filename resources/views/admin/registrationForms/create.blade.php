            ...
            <div class="form-group">
                ...
                @foreach(App\Models\RegistrationForm::FILLABLE_CURRENT_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('fillable_current') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="fillable_current_{{ $key }}" name="fillable_current" value="{{ $key }}" {{ old('fillable_current', '') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\RegistrationForm::FILLABLE_BACKLOG_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('fillable_backlog') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="fillable_backlog_{{ $key }}" name="fillable_backlog" value="{{ $key }}" {{ old('fillable_backlog', '') === (string) $key ? 'checked' : '' }}>

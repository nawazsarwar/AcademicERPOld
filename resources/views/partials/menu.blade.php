        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('controllers_office_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/students*") ? "menu-open" : "" }} {{ request()->is("admin/degrees*") ? "menu-open" : "" }} {{ request()->is("admin/courses*") ? "menu-open" : "" }} {{ request()->is("admin/papers*") ? "menu-open" : "" }} {{ request()->is("admin/enrolments*") ? "menu-open" : "" }} {{ request()->is("admin/boards*") ? "menu-open" : "" }} {{ request()->is("admin/*") ? "menu-open" : "" }} {{ request()->is("admin/*") ? "menu-open" : "" }} {{ request()->is("admin/*") ? "menu-open" : "" }} {{ request()->is("admin/*") ? "menu-open" : "" }} {{ request()->is("admin/*") ? "menu-open" : "" }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @can('examination_access')
                                <li class="nav-item has-treeview {{ request()->is("admin/course-students*") ? "menu-open" : "" }} {{ request()->is("admin/registration-forms*") ? "menu-open" : "" }} {{ request()->is("admin/exam-registrations*") ? "menu-open" : "" }} {{ request()->is("admin/registration-papers*") ? "menu-open" : "" }} {{ request()->is("admin/examination-schedules*") ? "menu-open" : "" }} {{ request()->is("admin/examiners*") ? "menu-open" : "" }}">
                                    <a class="nav-link nav-dropdown-toggle" href="#">
                                        <i class="fa-fw nav-icon fas fa-cogs">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        @can('registration_paper_access')
                                            <li class="nav-item">
                                                <a href="{{ route("admin.registration-papers.index") }}" class="nav-link {{ request()->is("admin/registration-papers") || request()->is("admin/registration-papers/*") ? "active" : "" }}">
                                                    <i class="fa-fw nav-icon fas fa-cogs">
                            ...
                            @can('result_processing_access')
                                <li class="nav-item has-treeview {{ request()->is("admin/examination-marks*") ? "menu-open" : "" }} {{ request()->is("admin/reevaluations*") ? "menu-open" : "" }} {{ request()->is("admin/reevaluation-papers*") ? "menu-open" : "" }}">
                                    <a class="nav-link nav-dropdown-toggle" href="#">
                                        <i class="fa-fw nav-icon fas fa-cogs">
                                    ...
                                    <ul class="nav nav-treeview">
                                        @can('examination_mark_access')
                                            <li class="nav-item">
                                                <a href="{{ route("admin.examination-marks.index") }}" class="nav-link {{ request()->is("admin/examination-marks") || request()->is("admin/examination-marks/*") ? "active" : "" }}">
                                                    <i class="fa-fw nav-icon fas fa-cogs">
                                        ...
                                        @can('reevaluation_access')
                                            <li class="nav-item">
                                                <a href="{{ route("admin.reevaluations.index") }}" class="nav-link {{ request()->is("admin/reevaluations") || request()->is("admin/reevaluations/*") ? "active" : "" }}">
                                                    <i class="fa-fw nav-icon fas fa-cogs">
                                        ...
                                        @can('reevaluation_paper_access')
                                            <li class="nav-item">
                                                <a href="{{ route("admin.reevaluation-papers.index") }}" class="nav-link {{ request()->is("admin/reevaluation-papers") || request()->is("admin/reevaluation-papers/*") ? "active" : "" }}">
                                                    <i class="fa-fw nav-icon fas fa-cogs">
                ...
                @can('demographic_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/people*") ? "menu-open" : "" }} {{ request()->is("admin/addresses*") ? "menu-open" : "" }} {{ request()->is("admin/phones*") ? "menu-open" : "" }} {{ request()->is("admin/biometrics*") ? "menu-open" : "" }} {{ request()->is("admin/academic-qualifications*") ? "menu-open" : "" }} {{ request()->is("admin/work-experiences*") ? "menu-open" : "" }} {{ request()->is("admin/orders*") ? "menu-open" : "" }} {{ request()->is("admin/*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @can('communication_centre_access')
                                <li class="nav-item has-treeview {{ request()->is("admin/notifications*") ? "menu-open" : "" }} {{ request()->is("admin/notificables*") ? "menu-open" : "" }}">
                                    <a class="nav-link nav-dropdown-toggle" href="#">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        @can('notificable_access')
                                            <li class="nav-item">
                                                <a href="{{ route("admin.notificables.index") }}" class="nav-link {{ request()->is("admin/notificables") || request()->is("admin/notificables/*") ? "active" : "" }}">
                                                    <i class="fa-fw nav-icon fas fa-cogs">
                ...
                @can('registrars_office_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/campuses*") ? "menu-open" : "" }} {{ request()->is("admin/faculties*") ? "menu-open" : "" }} {{ request()->is("admin/departments*") ? "menu-open" : "" }} {{ request()->is("admin/centres*") ? "menu-open" : "" }} {{ request()->is("admin/employees*") ? "menu-open" : "" }} {{ request()->is("admin/nominees*") ? "menu-open" : "" }} {{ request()->is("admin/family-members*") ? "menu-open" : "" }} {{ request()->is("admin/employment-statuses*") ? "menu-open" : "" }} {{ request()->is("admin/designation-types*") ? "menu-open" : "" }} {{ request()->is("admin/*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                            <i class="fa-fw nav-icon fas fa-cogs">
                ...
                @can('dean_students_welfare_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/halls*") ? "menu-open" : "" }} {{ request()->is("admin/hostels*") ? "menu-open" : "" }} {{ request()->is("admin/hostel-rooms*") ? "menu-open" : "" }} {{ request()->is("admin/hall-students*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                            <i class="fa-fw nav-icon fas fa-cogs">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @can('hall_student_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.hall-students.index") }}" class="nav-link {{ request()->is("admin/hall-students") || request()->is("admin/hall-students/*") ? "active" : "" }}">
                    ...
                    <li class="nav-item has-treeview {{ request()->is("admin/users*") ? "menu-open" : "" }} {{ request()->is("admin/roles*") ? "menu-open" : "" }} {{ request()->is("admin/permissions*") ? "menu-open" : "" }} {{ request()->is("admin/organizational-emails*") ? "menu-open" : "" }} {{ request()->is("admin/user-alerts*") ? "menu-open" : "" }} {{ request()->is("admin/audit-logs*") ? "menu-open" : "" }} {{ request()->is("admin/computer-centre-datas*") ? "menu-open" : "" }} {{ request()->is("admin/user-requests*") ? "menu-open" : "" }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @can('user_request_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.user-requests.index") }}" class="nav-link {{ request()->is("admin/user-requests") || request()->is("admin/user-requests/*") ? "active" : "" }}">
                ...
                @can('finance_office_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/admission-charges*") ? "menu-open" : "" }} {{ request()->is("admin/continuation-charges*") ? "menu-open" : "" }} {{ request()->is("admin/salary-datas*") ? "menu-open" : "" }} {{ request()->is("admin/receivables*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                ...
                @can('content_management_system_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/websites*") ? "menu-open" : "" }} {{ request()->is("admin/content-pages*") ? "menu-open" : "" }} {{ request()->is("admin/content-categories*") ? "menu-open" : "" }} {{ request()->is("admin/content-tags*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                            <i class="fa-fw nav-icon fas fa-book">
                ...
                @endcan
                @can('pay_hub_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/clients*") ? "menu-open" : "" }} {{ request()->is("admin/merchants*") ? "menu-open" : "" }} {{ request()->is("admin/services*") ? "menu-open" : "" }} {{ request()->is("admin/transactions*") ? "menu-open" : "" }} {{ request()->is("admin/dialogues*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                ...
                @can('university_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/organization-units-types*") ? "menu-open" : "" }} {{ request()->is("admin/organization-units*") ? "menu-open" : "" }} {{ request()->is("admin/designations*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                            <i class="fa-fw nav-icon fas fa-cogs">
                        ...
                        <ul class="nav nav-treeview">
                            @can('organization_units_type_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.organization-units-types.index") }}" class="nav-link {{ request()->is("admin/organization-units-types") || request()->is("admin/organization-units-types/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-cogs">
                            ...
                            @can('organization_unit_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.organization-units.index") }}" class="nav-link {{ request()->is("admin/organization-units") || request()->is("admin/organization-units/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-cogs">
